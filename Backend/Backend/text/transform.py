...
from fastai.torch_core import rank_distrib, collections
...
# __all__ = ['BaseTokenizer', 'SpacyTokenizer', 'Tokenizer', 'Vocab', 'fix_html', 'replace_all_caps', 'replace_rep',
#            'replace_wrep',
#            'rm_useless_spaces', 'spec_add_spaces', 'BOS', 'EOS', 'FLD', 'UNK', 'PAD', 'TK_MAJ', 'TK_UP', 'TK_REP',
#            'TK_REP', 'TK_WREP',
#            'deal_caps']
...
#             res.append(TK_UP); res.append(t.lower())
#         else:
#             res.append(t)
#     return res
#
